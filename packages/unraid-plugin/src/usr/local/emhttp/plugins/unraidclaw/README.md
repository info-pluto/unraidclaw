...
It proxies requests to Unraid's built-in GraphQL API with fine-grained access control, so you can safely expose Docker, VMs, Array, Shares, System, Host Execution, Notifications, and Network management to AI tools.
